...
im = Image.open('Python\\Ultimate Calculator\\assests\\calculator.png')
st.set_page_config(page_title='Ultimate Calculator', page_icon=im, layout='centered', initial_sidebar_state='auto')
st.title('Ultimate Calculator App')
